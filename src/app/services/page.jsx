...
export default function Services() {
    ...
    return (
        <main>
            <section className='text-center lg:text-left w-[80%] px-2 py-12  min-h-24 lg:min-h-28 lg:flex items-center justify-between max-w-[24cm] mx-auto'>
            ...
            <section className='pt-24 '>
                ...
                <section className='flex flex-wrap p-12 items-start justify-center gap-8'>
                    {
                        works.map((work, index) =>
                            <div key={index} className='flex items-center'>
                                <section className='w-full lg:w-40 max-w-[12cm] mx-auto md:mx-0'>
                                    ...
                                    <p className='pb-8 lg:pb-0'>{work.description}</p>
                                </section>
                ...
                <section className='md:flex gap-10 bg-[#eee] items-center justify-center p-12 md:py-16 md:px:12'>
                    ...
                    <section>
                         ...
                         <p className='text-md text-center md:text-start pb-8 w-80 mx-auto md:mx-0 md:w-90'>Collaborate with our experts to create tailored solutions that meets your needs.Together, we will craft a customized approach that exceeds your expectations.</p>
