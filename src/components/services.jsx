   ...
   return (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" data-aos="fade-up">
             {services && services.map((service, index) => (
              <div key={index} className={`group ${shadow || ''} ${bgCol || 'bg-gradient-to-br border'} from-slate-800 to-slate-900 p-8 rounded-2xl  border-slate-700 hover:border-purple-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10`} data-aos="fade-up"
