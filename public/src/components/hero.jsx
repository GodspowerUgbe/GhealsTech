        ...
        <section className='pt-24'>
            ...
            <section className='px-2 md:px-12 text-center md:text-start md:flex justify-between items-center'>
                ...
                <section className='w-9/10 mx-auto md:mx-0 md:w-2/5 min-w-80'>
                    ...
                    <Link href='' className="block w-fit md:mx-0 mb-12 mx-auto group bg-gradient-to-r from-purple-900 to-pink-400 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105 animate-pulse hover:animate-none">
